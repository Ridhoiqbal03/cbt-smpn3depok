    ...
    <section id="content">
        ...
        <div class="finished flex flex-col gap-[40px] items-center justify-center mt-[120px] mb-[30px] w-full">
            ...
            <div class="flex flex-col gap-[6px] justify-center text-center">
                @if(session('message'))
                    <h1 class="font-bold text-2xl text-red-600">{{ session('message') }}</h1>
                    <p class="text-[#7F8190] w-[374px]">Ujian telah diakhiri karena waktu habis. Anda dapat melihat hasil ujian di bawah ini.</p>
                @else
