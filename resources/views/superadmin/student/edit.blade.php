            ...
            <div class="w-full flex flex-col gap-[30px]">
                ...
                <ul class="flex flex-col gap-3">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="{{ route('dashboard.students.index') }}" class="p-[10px_16px] flex items-center gap-[14px] rounded-full h-11 bg-[#2B82FE] transition-all duration-300 hover:bg-[#2B82FE]">
                            <div>
                                <img src="{{asset('images/icons/profile-2user.svg')}}" alt="icon">
                            </div>
                            <p class="font-semibold text-white transition-all duration-300 hover:text-white">Students</p>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('dashboard.teachers.index') }}" class="p-[10px_16px] flex items-center gap-[14px] rounded-full h-11 transition-all duration-300 hover:bg-[#2B82FE]">
                            <div>
                                <img src="{{asset('images/icons/profile-2user.svg')}}" alt="icon">
                            </div>
                            <p class="font-semibold transition-all duration-300 hover:text-white">Teacher</p>
                        </a>
                    </li>
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    <a href="#" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Edit Student</a>
                </div>
            </div>
            <div class="header flex flex-col gap-1 px-5 mt-5">
                <h1 class="font-extrabold text-[30px] leading-[45px]">Edit Student</h1>
                <p class="text-[#7F8190]">Update details for the best student experience</p>
            </div>
            ...
            <form method="POST" enctype="multipart/form-data" action="{{ route('dashboard.students.update', $student->id) }}" class="flex flex-col gap-[30px] w-[500px] mx-[70px] mt-10">
            @csrf
            @method('PUT')
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                    ...
                    <input type="text" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Write student name" name="name" value="{{ $student->name }}" required>
                </div>
            </div>
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                    ...
                    <input type="email" id="email" name="email" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Enter student email" value="{{ $student->email }}" required>
                </div>
            </div>

            <!-- Password -->
            <div class="flex flex-col gap-[10px]">
                <label for="password" class="font-semibold">Password (Leave blank to keep unchanged)</label>
                <div class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] transition-all duration-300 focus-within:border-2 focus-within:border-[#0A090B]">
                    <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('images/icons/security-user.svg') }}" class="w-full h-full object-contain" alt="password icon">
                    </div>
                    <input type="password" id="password" name="password" class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none" placeholder="Enter new password">
                </div>
            </div>
