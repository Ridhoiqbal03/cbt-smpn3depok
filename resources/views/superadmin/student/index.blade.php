...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="student-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                <div class="student-list-header flex flex-nowrap justify-between pb-4 pr-10 border-b border-[#EEEEEE]">
                    ...
                    <div class="flex justify-center shrink-0 w-[170px]">
                        <p class="text-[#7F8190]">Date Registered</p>
                    </div>
                ...
                @forelse($students as $student)
                    <div class="list-items flex flex-nowrap justify-between pr-10">
                        <div class="flex shrink-0 w-[300px] items-center gap-4">
                            <div class="w-12 h-12 flex shrink-0 overflow-hidden rounded-full bg-gray-200 justify-center items-center text-white text-xl font-bold">
                        ...
                        <div class="flex shrink-0 w-[170px] items-center justify-center">
                            <p class="font-semibold">{{ \Carbon\Carbon::parse($student->created_at)->format('F j, Y') }}</p>
                        </div>
                        ...
                        <div class="flex shrink-0 w-[120px] items-center justify-center">
                            <div class="relative h-[41px]">
                                <div class="menu-dropdown w-[120px] max-h-[41px] overflow-hidden absolute top-0 p-[10px_16px] bg-white flex flex-col gap-3 border border-[#EEEEEE] transition-all duration-300 hover:shadow-[0_10px_16px_0_#0A090B0D] rounded-[18px]">
                                    ...
                                    <form method="POST" action="{{ route('dashboard.students.destroy', $student->id) }}">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="flex items-center justify-between font-bold text-sm w-full text-[#FD445E]" onclick="return confirmDeleteStudent('{{ $student->name }}')">
                                            Delete
                                        </button>
                                    </form>
                                </div>
    ...
    <script>
        function confirmDeleteStudent(studentName) {
            return confirm(`Apakah Anda yakin ingin menghapus student "${studentName}"? Tindakan ini tidak dapat dibatalkan.`);
        }
