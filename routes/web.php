...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('dashboard')->name('dashboard.')->group(function(){
       ...
       // route baru untuk nilai student
       Route::get('/course/students/result/{course}', [CourseStudentController::class, 'result' ])
       ->middleware('role:teacher')
       ->name('course.result');

       // route untuk cetak nilai student excel
       Route::get('/courses/{id}/export-excel', [CourseStudentController::class, 'export'])
       ->middleware('role:teacher')
       ->name('courses.export');
